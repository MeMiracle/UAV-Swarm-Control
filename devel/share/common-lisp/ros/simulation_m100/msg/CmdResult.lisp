...
(cl:defmethod cl:initialize-instance :after ((m <CmdResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CmdResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_m100-msg:<CmdResult> is deprecated: use simulation_m100-msg:CmdResult instead.")))
...
(cl:defmethod command-val ((m <CmdResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:command-val is deprecated.  Use simulation_m100-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <CmdResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:status-val is deprecated.  Use simulation_m100-msg:status instead.")
  (status m))
