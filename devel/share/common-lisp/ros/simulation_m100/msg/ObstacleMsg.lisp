...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_m100-msg:<ObstacleMsg> is deprecated: use simulation_m100-msg:ObstacleMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:header-val is deprecated.  Use simulation_m100-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:center-val is deprecated.  Use simulation_m100-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'point1-val :lambda-list '(m))
(cl:defmethod point1-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:point1-val is deprecated.  Use simulation_m100-msg:point1 instead.")
  (point1 m))

(cl:ensure-generic-function 'point2-val :lambda-list '(m))
(cl:defmethod point2-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:point2-val is deprecated.  Use simulation_m100-msg:point2 instead.")
  (point2 m))

(cl:ensure-generic-function 'minRadius-val :lambda-list '(m))
(cl:defmethod minRadius-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-msg:minRadius-val is deprecated.  Use simulation_m100-msg:minRadius instead.")
  (minRadius m))
