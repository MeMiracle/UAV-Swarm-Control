...
(cl:in-package simulation_m100-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <EnableMotors-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnableMotors-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_m100-srv:<EnableMotors-request> is deprecated: use simulation_m100-srv:EnableMotors-request instead.")))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <EnableMotors-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-srv:enable-val is deprecated.  Use simulation_m100-srv:enable instead.")
  (enable m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EnableMotors-request>)))
  ...
  "simulation_m100/EnableMotorsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EnableMotors-request)))
  "Returns string type for a service object of type 'EnableMotors-request"
  "simulation_m100/EnableMotorsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <EnableMotors-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnableMotors-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_m100-srv:<EnableMotors-response> is deprecated: use simulation_m100-srv:EnableMotors-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <EnableMotors-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_m100-srv:success-val is deprecated.  Use simulation_m100-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EnableMotors-response>)))
  ...
  "simulation_m100/EnableMotorsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EnableMotors-response)))
  "Returns string type for a service object of type 'EnableMotors-response"
  "simulation_m100/EnableMotorsResponse")
