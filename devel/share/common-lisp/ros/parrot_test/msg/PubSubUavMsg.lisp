...
(cl:defmethod cl:initialize-instance :after ((m <PubSubUavMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PubSubUavMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parrot_test-msg:<PubSubUavMsg> is deprecated: use parrot_test-msg:PubSubUavMsg instead.")))

(cl:ensure-generic-function 'str-val :lambda-list '(m))
(cl:defmethod str-val ((m <PubSubUavMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parrot_test-msg:str-val is deprecated.  Use parrot_test-msg:str instead.")
  (str m))
