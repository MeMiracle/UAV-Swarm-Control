...
(cl:defmethod cl:initialize-instance :after ((m <send_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'send_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gcs-msg:<send_msg> is deprecated: use gcs-msg:send_msg instead.")))

(cl:ensure-generic-function 'send_msg-val :lambda-list '(m))
(cl:defmethod send_msg-val ((m <send_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gcs-msg:send_msg-val is deprecated.  Use gcs-msg:send_msg instead.")
  (send_msg m))
