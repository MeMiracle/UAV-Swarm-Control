...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wifistatus-msg:<Position> is deprecated: use wifistatus-msg:Position instead.")))

(cl:ensure-generic-function 'kind-val :lambda-list '(m))
(cl:defmethod kind-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifistatus-msg:kind-val is deprecated.  Use wifistatus-msg:kind instead.")
  (kind m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifistatus-msg:x-val is deprecated.  Use wifistatus-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifistatus-msg:y-val is deprecated.  Use wifistatus-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifistatus-msg:z-val is deprecated.  Use wifistatus-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Position>)))
  ...
  "381238523f8add39b00b8a991b078417")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Position)))
  "Returns md5sum for a message object of type 'Position"
  "381238523f8add39b00b8a991b078417")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Position>)))
  ...
  (cl:format cl:nil "int32 kind~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Position)))
  "Returns full string definition for message of type 'Position"
  (cl:format cl:nil "int32 kind~%float32 x~%float32 y~%float32 z~%~%"))
