...
(cl:defmethod cl:initialize-instance :after ((m <UavBaseInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UavBaseInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m100_v2-msg:<UavBaseInfo> is deprecated: use m100_v2-msg:UavBaseInfo instead.")))

(cl:ensure-generic-function 'cluster_id-val :lambda-list '(m))
(cl:defmethod cluster_id-val ((m <UavBaseInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:cluster_id-val is deprecated.  Use m100_v2-msg:cluster_id instead.")
  (cluster_id m))
