...
(cl:defmethod cl:initialize-instance :after ((m <CommInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m100_v2-msg:<CommInfo> is deprecated: use m100_v2-msg:CommInfo instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <CommInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:frame_id-val is deprecated.  Use m100_v2-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'src_address-val :lambda-list '(m))
(cl:defmethod src_address-val ((m <CommInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:src_address-val is deprecated.  Use m100_v2-msg:src_address instead.")
  (src_address m))

(cl:ensure-generic-function 'comm_bytes-val :lambda-list '(m))
(cl:defmethod comm_bytes-val ((m <CommInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:comm_bytes-val is deprecated.  Use m100_v2-msg:comm_bytes instead.")
  (comm_bytes m))
