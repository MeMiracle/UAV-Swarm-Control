...
(cl:defmethod cl:initialize-instance :after ((m <PubSubUavMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PubSubUavMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m100_v2-msg:<PubSubUavMsg> is deprecated: use m100_v2-msg:PubSubUavMsg instead.")))

(cl:ensure-generic-function 'src_uav_id-val :lambda-list '(m))
(cl:defmethod src_uav_id-val ((m <PubSubUavMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:src_uav_id-val is deprecated.  Use m100_v2-msg:src_uav_id instead.")
  (src_uav_id m))
...
(cl:defmethod cmd_priority-val ((m <PubSubUavMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:cmd_priority-val is deprecated.  Use m100_v2-msg:cmd_priority instead.")
  (cmd_priority m))

(cl:ensure-generic-function 'playload-val :lambda-list '(m))
(cl:defmethod playload-val ((m <PubSubUavMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:playload-val is deprecated.  Use m100_v2-msg:playload instead.")
  (playload m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <PubSubUavMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:start_time-val is deprecated.  Use m100_v2-msg:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'tgt_uav_count-val :lambda-list '(m))
(cl:defmethod tgt_uav_count-val ((m <PubSubUavMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-msg:tgt_uav_count-val is deprecated.  Use m100_v2-msg:tgt_uav_count instead.")
  (tgt_uav_count m))
