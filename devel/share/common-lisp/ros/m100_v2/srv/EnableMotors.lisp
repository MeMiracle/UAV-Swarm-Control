...
(cl:defmethod cl:initialize-instance :after ((m <EnableMotors-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnableMotors-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m100_v2-srv:<EnableMotors-request> is deprecated: use m100_v2-srv:EnableMotors-request instead.")))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <EnableMotors-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-srv:enable-val is deprecated.  Use m100_v2-srv:enable instead.")
  (enable m))
...
(cl:defmethod cl:initialize-instance :after ((m <EnableMotors-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnableMotors-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m100_v2-srv:<EnableMotors-response> is deprecated: use m100_v2-srv:EnableMotors-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <EnableMotors-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m100_v2-srv:success-val is deprecated.  Use m100_v2-srv:success instead.")
  (success m))
