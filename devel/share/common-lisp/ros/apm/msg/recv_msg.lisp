...
(cl:defmethod cl:initialize-instance :after ((m <recv_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'recv_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name apm-msg:<recv_msg> is deprecated: use apm-msg:recv_msg instead.")))

(cl:ensure-generic-function 'recv_msg-val :lambda-list '(m))
(cl:defmethod recv_msg-val ((m <recv_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apm-msg:recv_msg-val is deprecated.  Use apm-msg:recv_msg instead.")
  (recv_msg m))
