...
void syncfly_task_callback(const simulation_m100::PubSubUavMsg move_cmd_msg);//订阅并分析控制指令
...
int main(int argc, char *argv[])
{
	...
	//pthread_create(&syncflyThread,NULL,syncFly,NULL);
...
int XorY = 0;
double velocity = 1;
void syncfly_task_callback(const simulation_m100::PubSubUavMsg syncfly_task_msg)//
{
