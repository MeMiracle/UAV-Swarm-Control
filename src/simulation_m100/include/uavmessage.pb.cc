...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgHead, time_stamp_),
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "m\030\t \001(\r\022\022\n\ntgt_uav_id\030\n \003(\r\022\022\n\ntime_stam"
      "p\030\023 \001(\001\022\020\n\010reserved\030\024 \001(\r\"A\n\007Message\022$\n\007"
      "msghead\030\001 \001(\0132\023.uavMessage.MsgHead\022\020\n\010pl"
      "ayload\030\002 \001(\014b\006proto3"
  };
...
const int MsgHead::kTimeStampFieldNumber;
...
MsgHead::MsgHead(const MsgHead& from)
  ...
  ::memcpy(&stx_, &from.stx_,
    ...
    reinterpret_cast<char*>(&stx_)) + sizeof(time_stamp_));
...
void MsgHead::SerializeWithCachedSizes(
  ...
  if (this->time_stamp() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(19, this->time_stamp(), output);
  }
...
::google::protobuf::uint8* MsgHead::InternalSerializeWithCachedSizesToArray(
  ...
  // double time_stamp = 19;
  if (this->time_stamp() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(19, this->time_stamp(), target);
  }
...
// double time_stamp = 19;
void MsgHead::clear_time_stamp() {
  time_stamp_ = 0;
}
double MsgHead::time_stamp() const {
  // @@protoc_insertion_point(field_get:uavMessage.MsgHead.time_stamp)
  return time_stamp_;
}
void MsgHead::set_time_stamp(double value) {
